...
<div id="page-wrapper" >
    <div id="page-inner">
        ...
        <!--  <div class="table-responsive"> -->
                        <!-- table 1 -->
                        <form action="{{ route('pembelian.laporan') }}" method="get" class="pull-left">
                            <table>
                                <tr>
                            ...
                            <tbody>
                                ...
                                @if(isset($data_beli))
                                    ...
                                    <tr>
                                        ...
                                        <td>Rp. {{ $laporan->harga_pokok_beli }}</td>
    ...
    <script type="text/javascript">
        ...
        $('#printpdf').on('click', function(){
            ...
            if (tgl_1 == '' || tgl_2 == '') {
                ...
                var url = "{{url('/print_pdf_pembelian?tanggal1=')}}"+tgl_1+'&tanggal2='+tgl_2;
